          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Here are students with diente",
                    style: GoogleFonts.rubik(fontSize: 18)),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 15),
                child: patientStates(0, 'Student Year', 55,context),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 15),
                child: patientStates(1, 'Student Year', 80,context),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 15),
                child: patientStates(2, 'Student Year', 80, context),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 15),
                child: patientStates(3, 'Student Year', 80, context),
              ),
            ],
          ),
        ),
